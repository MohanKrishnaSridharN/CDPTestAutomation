...
//		System.out.println("after port");
		...
		protected PasswordAuthentication getPasswordAuthentication() {
		  ...
		  try {
	         ...
	         message.setSubject("CDP-API Automation Test Report || "+"Customer "+browser +" || "+timeStamp);	 
	 		
	         // Create the message part
	         BodyPart messageBodyPart = new MimeBodyPart();

	         // Now set the actual message
	         String htmlText = "<h3> PFA... Test Reports </h3>"
	        		+ "<h3> Please find the following URL for previous reports</h3> "
	         		+ "<h3> http://54.147.216.121/cdpauto/</h3> <br> "
	        		+ "<h4> *This Message Generated by Automation Test Scripts </h4> ";
	         messageBodyPart.setContent(htmlText+"<br>", "text/html");

	         // Create a multipar messageh3
